...
class StockAdapter(
    layoutId: Int,
    variableId: Int,
    adapterDatas: List<Map<String, List<AislesBindGoodsEntity>>>,
    private var listener: ((holder: ItemViewHolder2, Map<String, List<AislesBindGoodsEntity>>) -> Unit)? = null
) : BaseAdapter2<Map<String, List<AislesBindGoodsEntity>>>(layoutId, variableId, adapterDatas) {
    override fun convert(
        holder: ItemViewHolder2,
        position: Int,
        t: Map<String, List<AislesBindGoodsEntity>>
    ) {

 ...
 * </pre>
 */
public final class DKToastUtils {
    ...
    public static void setGravity(final int gravity, final int xOffset, final int yOffset) {
        DKToastUtils.gravity = gravity;
        DKToastUtils.xOffset = xOffset;
        DKToastUtils.yOffset = yOffset;
    }
    ...
    public static void setBgColor(@ColorInt final int backgroundColor) {
        DKToastUtils.bgColor = backgroundColor;
    }
    ...
    public static void setBgResource(@DrawableRes final int bgResource) {
        DKToastUtils.bgResource = bgResource;
    }
    ...
    public static void setMsgColor(@ColorInt final int msgColor) {
        DKToastUtils.msgColor = msgColor;
    }
     ...
     * 安全地显示短时自定义吐司
     */
    public static View showCustomShort(String msg) {
        final View view = getView(R.layout.toast_custom_view);
        ((TextView) view.findViewById(R.id.tvToastMsg)).setText(msg);
        show(view, Toast.LENGTH_SHORT);
        return view;
    }
     ...
     * 安全地显示短时自定义吐司
     */
    public static View showCustomShort(@IdRes final int texxId, String msg) {
        final View view = getView(R.layout.toast_custom_view);
        ((TextView) view.findViewById(R.id.tvToastMsg)).setText(msg);
        show(view, Toast.LENGTH_SHORT);
        return view;
     ...
     * 安全地显示长时自定义吐司
     */
    public static View showCustomLong(String msg) {
        final View view = getView(R.layout.toast_custom_view);
        ((TextView) view.findViewById(R.id.tvToastMsg)).setText(msg);
        show(view, Toast.LENGTH_LONG);
        return view;
